...
export default function Home() {
  return (
    <main className="h-full overflow-auto">
      <MinHeader />
      <article>
        <section className="relative w-full aspect-[16/9] sm:aspect-[21/9] lg:aspect-[3/1] bg-[rgb(28,81,145)]">
        ...
        <section className="flex flex-col items-center justify-center p-12 my-16 text-center bg-gray-50 ">
        ...
        <footer className="bg-gray-900 h-[20vh] flex">
